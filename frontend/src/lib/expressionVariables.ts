...
const NODE_OUTPUT_FIELDS: Record<string, string[]> = {
  ...
  "Load Conversation State":  ["session_id", "session_ref_id", "messages", "message_count", "summary_text", "summary_through_turn", "active_episode_id"],
  "Save Conversation State":  ["saved", "session_id", "session_ref_id", "message_count", "active_episode_id", "summary_updated", "promoted_memory_records", "promoted_entity_facts"],
  "Archive Active Episode":   ["archived", "episode_id", "session_id", "title", "summary_text", "archive_reason", "memory_records_created"],
  "Condition":                [],
  "Merge":                    [],
  "ForEach":                  [],
